...
(Table~\ref{tab:general}, Fig.~\ref{fig:general}): every coordinate-wise rule
...
\begin{table}[t]
\caption{Sign-flip robustness across datasets ($c{=}3$): final test accuracy (\%),
mean over seeds. Coordinate-wise rules collapse to chance at $f{\ge}0.2$ on every
dataset; CB-SAFE+ tracks the clean baseline. (CIFAR-10, FashionMNIST: 3 seeds;
Edge-IIoTset: 1 seed.)}
\label{tab:general}
\centering
\footnotesize
...
\toprule
Dataset & Rule & clean & $f{=}.1$ & $f{=}.2$ & $f{=}.3$\\
\midrule
CIFAR-10 & Median      & 59.0 & 47.8 & 10.0 & 10.0\\
(images) & Multi-Krum  & 59.0 & 53.6 & 39.8 & 20.3\\
         & CB-SAFE+    & 59.0 & 52.6 & \textbf{45.6} & \textbf{46.4}\\
\midrule
FashionMNIST & Median     & 88.5 & 84.9 & 10.0 & 10.0\\
(images)     & Multi-Krum & 88.5 & 85.9 & 83.0 & 43.1\\
             & CB-SAFE+   & 88.5 & 85.8 & \textbf{86.1} & \textbf{84.1}\\
\midrule
Edge-IIoTset & Median     & 63.7 & 59.6 & 13.6 & 7.3\\
(tabular)    & Multi-Krum & 63.7 & 63.3 & 59.4 & 38.5\\
             & CB-SAFE+   & 63.7 & 61.9 & \textbf{62.3} & \textbf{61.5}\\
\bottomrule
\end{tabular}
\end{table}
