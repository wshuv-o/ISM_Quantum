...
framework whose post-quantum confidentiality is established by the NIST-standardized code-based KEM
...
NIST-standardized code-based KEM (HQC) rather than a lattice KEM, at the same NIST security levels.
...
variants differ only in one module. (iii)~No prior framework brings a standardized code-based KEM
